...
When working with 18650 batteries, I quickly realized that **length variations** caused by protection circuits make off-the-shelf holders unreliable. Some batteries fit too tightly, while others are nearly impossible to remove. To solve this, I decided to design and print my own holder.
