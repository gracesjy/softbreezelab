...
All software examples shown in this article were generated with the assistance of AI tools.

The source code itself is not the primary focus of this project and should be considered as reference implementations only.

The important parts are the hardware interfaces, GPIO assignments, communication buses, and overall system architecture.

Please refer to the GPIO mappings and hardware connections as needed, and feel free to adapt or replace the software implementation according to your own requirements.
